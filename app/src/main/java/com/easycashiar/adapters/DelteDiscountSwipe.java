...
public class DelteDiscountSwipe extends ItemTouchHelper.SimpleCallback {
    ...
    public DelteDiscountSwipe(Context context, int dragDirs, int swipeDirs, SwipeListener listener) {
    ...
    public void onChildDraw(@NonNull Canvas c, @NonNull RecyclerView recyclerView, @NonNull RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurrentlyActive) {
        ...
        DiscountsAdapter.DiscountViewholder holder = (DiscountsAdapter.DiscountViewholder) viewHolder;
