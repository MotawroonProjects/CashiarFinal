package com.easycashiar.mvp.activity_customers_mvp;
...
public class ActivityCustomersPresenter {
    ...
    public ActivityCustomersPresenter(CustomersActivityView view, Context context) {
        this.view = view;
    ...
    public void deletecustomer(int id, UserModel userModel) {
        view.onLoad();
        Api.getService(Tags.base_url)
                .deltecustomer("Bearer " + userModel.getToken(), id+"")
