...
public class DelteproductSwipe extends ItemTouchHelper.SimpleCallback {

    private SwipeListener listener;
    private Context context;

    public DelteproductSwipe(Context context, int dragDirs, int swipeDirs, SwipeListener listener) {
    ...
    public void onChildDraw(@NonNull Canvas c, @NonNull RecyclerView recyclerView, @NonNull RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurrentlyActive) {
        ...
        ProductsAdapter.ProductsViewholder holder = (ProductsAdapter.ProductsViewholder) viewHolder;
