package com.easycashiar.mvp.activity_add_account_mvp;
...
public class ActivityAddAccountPresenter {
    ...
    public ActivityAddAccountPresenter(AddAccountActivityView view, Context context) {
        this.view = view;
    ...
    public void checkData(AddAccountModel addAccountModel, UserModel userModel) {
        if (addAccountModel.isDataValid(context)) {
    ...
    private void addaccount(AddAccountModel addAccountModel, UserModel userModel) {
        ...
        Api.getService(Tags.base_url)
                .addaccount("Bearer " + userModel.getToken(), addAccountModel.getName())
