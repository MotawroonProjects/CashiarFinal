...
public class ActivityCartBillBuyPresenter {
    private UserModel userModel;
    private Preferences preferences;
    private CartBillBuyActivityView view;
    private Context context;

    public ActivityCartBillBuyPresenter(CartBillBuyActivityView view, Context context) {
        this.view = view;
